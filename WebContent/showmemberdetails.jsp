...
<div id="templatemo_content_wrapper1">
     ...
     <div id="templatemo_content">
    	...
    	<td valign="top">
  	   		  ...
  	   		  <% 
  			out.print("<font color='black'>Details of Members</font>");
%>
<table><%
     	 ...
     	 if(request.getAttribute("deleted")!=null)
			{
			out.print("<div>");
			out.print("<font color='gray'><font size='5'>"+request.getAttribute("deleted")+"");
		...
		%></table><%
		out.print("<td><a href='searchmember.jsp'>Search</a></td>");
		out.print("<br>");
%>
<table height="100" border='1' align="center"><%
      	...
      	try {
			...
			PreparedStatement ps=con.prepareStatement("Select * from NEWMEMBER");
			
			ResultSet rs=ps.executeQuery();
			
			//out.print("<td><a href='deletemember.jsp'>Delete</a></td>");	
			//out.print("<td><td><a href='amemberupdate.jsp'>Update</a></td></td>");
			
			out.print("<tr><th>ID</th><th>NAME</th></th><th>PHONE</th><th>ADDRESS</th></tr>");
			while(rs.next()){
				//int id=rs.getInt(1);
