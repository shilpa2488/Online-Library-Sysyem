...
<table width="300" height="100" border="0" cellspacing="10" cellpadding="0" align="center"><%
	    ...
	    boolean status=verifyLogin2.checkLogin(username1,password);
		
		try {
		if(status==true){System.out.println("I am here");
		session.setAttribute("username", username1);
		System.out.println("username is "+session.getAttribute("username"));
		System.out.println("username is "+username1);
		if(session.getAttribute("username")==username1){
...
/* 			out.print("<font color='black'><font size='4'>Welcome    " + username);
		...
		//	out.println("<br><br><a href='newstaff.jsp'> Create new staff </a><br>");
			out.println("<br><a href='showstaff.jsp'> Show staff deatils </a>");
			out.println("<br><a href='bookdetails.jsp'> Show Book deatils </a>");
			out.println("<br><a href='memberdetails.jsp'> Show Member deatils </a>"); */
