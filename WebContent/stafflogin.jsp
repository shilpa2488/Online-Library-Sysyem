...
<div id="templatemo_content_wrapper1">
     ...
     <div id="templatemo_content">
    	...
    	<td valign="top">
				 ...
				 <h2><%  out.print("<font color=blue>WELCOME TO Staff LOGIN");
	%></h2>
    
    	<form name=F1 onSubmit="return dil(this)" action="staff1login1.jsp" >
				   <table cellspacing="10" cellpadding="8">	
				  <%if(request.getAttribute("check")!=null)
			{
			out.print("<div>");
			out.print("<font color='blue'><font size='5'>"+request.getAttribute("check")+"");
