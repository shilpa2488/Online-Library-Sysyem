...
<div id="templatemo_content_wrapper1">  
     <div id="templatemo_content">    
    	...
    	<td valign="top">
    	<h2><%  out.print("<font color=black>Details of Books");
	%></h2>
...
<table><%
     	 ...
     	 if(request.getAttribute("newbook")!=null)
			{
			out.print("<div>");
			out.print("<font color='black'>"+request.getAttribute("newbook")+"");
...
<table height="100" align="center"><%
      	...
      	try {
			...
			out.print("<td>");
			out.print("<td><a href='updatebookdetails.jsp'>Add</a></td>");	
			%></table>
<table height="100" border='1' align="center"><%	
			out.print("<tr><th>ID</th><th>BOOKNAME</th><th>AUTHOR</th><th>LINK</th></tr>");
			while(rs.next()){
				//int id=rs.getInt(1);
