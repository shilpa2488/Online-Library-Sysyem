...
<table width="300" align="center"><%
			...
			out.print("<font color='blue'><font size='5'>You have logged out successfully..!");
			out.println("<br>");	
			out.println("<td>" + "<br><a href='member.jsp''>Login Again</a><br>");
			out.println("<br>");
			out.println("<br>");
			out.println("<br>");
			request.setAttribute("logout","You have logged out successfully");			 
