...
<div id="templatemo_content_wrapper1">
     ...
     <div id="templatemo_content">
    	...
    	<td valign="top">
  	   			...
  	   			<form name=F1 onSubmit="return dil(this)" action="updatestaffdetails1.jsp" >
		...
		<tr><td>USERNAME:</td><td> <input type="text" name="Username" value="<%=rs.getString("USERNAME")%>" readonly="readonly"/></td></tr>	
