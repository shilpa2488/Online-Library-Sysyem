...
<div id="templatemo_content_wrapper">
	...
	<div id="templatemo_sidebar">
        ...
        <div class="sidebar_box">
            ...
            <form action="www.onlinelibrary.com" method="get">
...
<table><%
		...
		try {
			PreparedStatement ps=con.prepareStatement("delete  from NEWMEMBER where id = '"+id+"' ");
			
			ResultSet rs=ps.executeQuery();
           			
		    if(rs.next()){          			
	        out.print("<font color=gray size=3>your Details has been deleted</font>");
