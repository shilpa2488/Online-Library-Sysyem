...
<div id="templatemo_content_wrapper1">
     ...
     <div id="templatemo_content">
    	...
    	<td valign="top">
  	   			...
  	   			<form name=F1 onSubmit="return dil(this)" action="searchstaff1.jsp" >
				 <!--  <table cellspacing="5" cellpadding="3">	 -->
				  <table width="100" height="100" cellspacing="5" cellpadding="3" align="left">
			...
			out.print("</div>"); 
			 ...
			 %>
				  ...
				  <tr></tr>
					...
					<tr><td>Staff NAME:</td><td> <input type="text" name="staffname"/></td></tr>
					
				<tr><td><a href='showstaff.jsp'>Back</a>
