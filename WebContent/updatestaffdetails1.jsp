...
<table><%
		...
		try {
			PreparedStatement ps=con.prepareStatement("update newstaffmember set USERNAME='"+username+"',PASSWORD= '"+pass+"', REPASSWORD= '"+pass+"', PHONE= '"+ph+"', ADDERESS = '"+Address+"' where ID = '"+id+"'");
			updateQuery = ps.executeUpdate();
            if(updateQuery != 0){  
	        out.print("your Details has been updated");
			request.setAttribute("deleted","your Details has been updated");
			%>			
			<jsp:forward page="updatestaffaccount.jsp"></jsp:forward> 
			<% 
