...
<table width="300" align="center"><%
	...
	String id = request.getParameter("id");
	    ...
	    int status = ReturnBook.returnBook(id);
	    System.out.println("status :"+status);
		if(status>0){
		
	out.print("<font color='black'><font size='5'>Return done successfully..!");
	out.println("<br>");
	out.println("<br>");
	out.println("<br>");
	request.setAttribute("return","Return done successfully");		
	out.print("<font size='3'><a href='returnbook.jsp'>back</a>");
	}				
		else{
